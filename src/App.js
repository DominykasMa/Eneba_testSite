    ...
    <div className="App">
      <Header/>
        ...
        <div className="container three-cols">
          ...
          <p className="second-col">Suspendisse eu orci elit. In id commodo mauris. Fusce nec imperdiet nibh. Integer a erat sceleri sque, pellentesque leo a, posuere justo. Etiam maximus, nibh a luctus sagittis, nibh elit tempus est, non dapibus nunc.</p>
